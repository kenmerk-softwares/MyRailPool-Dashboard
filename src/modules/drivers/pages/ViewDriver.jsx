  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        ...
        <p className="text-slate-400 font-bold text-xs uppercase tracking-widest text-center">Synchronizing Records...</p>
      </div>
    );
  }
    ...
    <div className="w-full max-w-full mx-auto pb-10 px-2 animate-in fade-in duration-300">
      ...
      <header className="flex items-center justify-between mb-4 bg-white p-4 border border-slate-200 rounded-xl shadow-sm">
        <div className="flex items-center gap-5">
          <Link to="/drivers" className="p-2.5 bg-slate-50 text-slate-400 hover:text-slate-600 rounded-lg transition-all">
          ...
          <div>
            ...
            <div className="flex items-center gap-6 text-[11px] font-black text-slate-400 mt-1.5 uppercase tracking-tight">
        ...
        <div className="p-8 space-y-12">
          {sections.map((section, sIdx) => (
            <section key={sIdx}>
              <div className="flex items-center gap-2 mb-6 border-b border-slate-50 pb-3">
                ...
                <h3 className="text-[11px] font-black text-slate-400 uppercase tracking-widest">{section.title}</h3>
              </div>
                    ...
                    <div className="flex items-center gap-2">
                      {field.isBadge ? (
                        <span className={`text-[12px] font-black uppercase tracking-widest ${
                          field.value?.toLowerCase() === 'yes' || field.value?.toLowerCase() === 'active' || field.value?.toLowerCase() === 'inducted'
          ...
          <section className="pt-2">
            <div className="flex items-center gap-2 mb-4 border-b border-slate-50 pb-3">
              ...
              <h3 className="text-[11px] font-black text-slate-400 uppercase tracking-widest">Confidential Records</h3>
            </div>
